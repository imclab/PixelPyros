...
void testApp::guiSetup() {
	...
	gui.addSlider("Gain", phoneTracker.cameraManager.gain, 180, 1023).setSize(200,30); 
	gui.addSlider("Gamma", phoneTracker.cameraManager.gamma, 10, 22).setSize(200,30); 
	gui.addSlider("Brightness", phoneTracker.cameraManager.brightness, 0, 255).setSize(200,30); 
	gui.addSlider("Shutter", phoneTracker.cameraManager.shutter, 1, 512).setSize(200,30); 
