...
class RocketThinFountain : public RocketSettings {
	
    public :
    
    RocketThinFountain(float hueStartOffset = 0, float hueChange = 0, float explosionHue = 20, ParticleRendererBase * renderer1 = NULL, ParticleRendererBase * renderer2 = NULL) : RocketSettings() {
