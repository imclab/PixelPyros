...
public:
	...
	void setup(int width, int height) {
		ofxControlPanel::setup("Control Panel", 0, 0, width, height);
	}
	...
	guiTypeSlider * addSlider(string name, string xmlName, float value, float low, float high, bool isInt = false) {
		return ofxControlPanel::addSlider(name, xmlName, value, low, high, isInt);
	}
	guiTypeSlider * addSlider(string name, float value, float low, float high, bool isInt = false) {
		return ofxControlPanel::addSlider(name, name, value, low, high, isInt);
	}
